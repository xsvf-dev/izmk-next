...
public class MergeTask2 extends DefaultTask {
    public File loader;
    public File core;
    public File output;
    ...
    public void run() throws IOException {
        ...
        try (ZipInputStream loaderZip = new ZipInputStream(new FileInputStream(loader));
             ...
             InputStream coreFileProvider = MergeTask2.class.getResourceAsStream("/ovo/xsvf/encrypt/SimpleCoreFileProvider2.class");
