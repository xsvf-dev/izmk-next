    ...
    private static class Fixer extends ClassFixer {
        ...
        public final @NotNull MethodVisitor visitMethod(final int access, final String name, final String descriptor, final String signature, final String[] exceptions) {
            ...
            return new MethodVisitor(RenamerImpl.MAX_ASM_VERSION, parent) {
                @Override
                public void visitLocalVariable(final @NotNull String pname, final String pdescriptor, final String psignature, final Label start, final Label end, final int index) {
                ...
                private @NotNull String fixName(@NotNull String name, int index) {
                    boolean valid = true;
                    if (name.isEmpty()) {
                        valid = false;
