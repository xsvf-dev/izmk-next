...
class EnhancedClassRemapper extends ClassRemapper {
    ...
    @Override
    public @Nullable MethodVisitor visitMethod(final int access, final String mname, final @NotNull String mdescriptor, final String msignature, final String @Nullable [] exceptions) {
        ...
        return new MethodRemapper(methodVisitor, remapper) {
            ...
            @Override
            public void visitInvokeDynamicInsn(final String name, final @NotNull String descriptor, final Handle bootstrapMethodHandle, final Object @NotNull ... bootstrapMethodArguments) {
    ...
    private void renameAbstract(int access, String name, @NotNull String descriptor) {
