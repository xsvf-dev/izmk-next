...
public interface ClassProvider extends Closeable {
     ...
     * @see #builder()
     */
    static ClassProvider fromPaths(Path @NotNull ... paths) {
     ...
     */
    static @NotNull ClassProvider fromJvmClasspath() {
     ...
     */
    static @NotNull ClassProvider fromClassLoader(ClassLoader classLoader) {
