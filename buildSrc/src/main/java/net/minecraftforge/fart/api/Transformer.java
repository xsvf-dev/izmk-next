...
import net.minecraftforge.fart.internal.*;
...
public interface Transformer {
     ...
     * @return the transformed entry
     */
    default @Nullable ResourceEntry process(ResourceEntry entry) {
        return entry;
    }
     ...
     */
    default @NotNull Collection<? extends Entry> getExtras() {
     ...
     */
    static @NotNull Factory renamerFactory(IMappingFile map, boolean collectAbstractParams) {
     ...
     */
    @Deprecated
    static @NotNull Factory renamerFactory(IMappingFile map) {
     ...
     */
    public static @NotNull Factory identifierFixerFactory(final IdentifierFixerConfig config) {
     ...
     */
    public static @NotNull Factory parameterAnnotationFixerFactory() {
     ...
     */
    public static @NotNull Factory fernFlowerLineFixerFactory(@NotNull File sourceJar) {
     ...
     */
    public static @NotNull Factory recordFixerFactory() {
     ...
     */
    public static @NotNull Factory sourceFixerFactory(SourceFixerConfig config) {
     ...
     */
    public static @NotNull Factory signatureStripperFactory(SignatureStripperConfig config) {
    ...
    public interface ClassEntry extends Entry {
         ...
         */
        static @NotNull ClassEntry create(@NotNull String name, long time, byte[] data) {
         ...
         * @return the class entry
         */
        static @NotNull ClassEntry create(String cls, long time, byte[] data, int version) {
    ...
    public interface ResourceEntry extends Entry {
         ...
         */
        static @NotNull ResourceEntry create(String name, long time, byte[] data) {
    ...
    public interface ManifestEntry extends Entry {
         ...
         */
        static @NotNull ManifestEntry create(long time, byte[] data) {
    ...
    public interface Factory {
         ...
         */
        public static @NotNull Factory always(final Transformer transformer) {
