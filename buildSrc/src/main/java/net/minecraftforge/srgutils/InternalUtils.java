...
class InternalUtils {
    static IMappingFile load(@NotNull InputStream in) throws IOException {
        INamedMappingFile named = loadNamed(in);
        return named.getMap(named.getNames().get(0), named.getNames().get(1));
    }

    static INamedMappingFile loadNamed(@NotNull InputStream in) throws IOException {
    ...
    private static @NotNull List<String> filter(@NotNull List<String> lines) {
     ...
     *
     */
    private static @NotNull IMappingBuilder loadSRG(@NotNull List<String> lines) throws IOException {
     ...
     *
     */
    private static @NotNull IMappingBuilder loadProguard(@NotNull List<String> lines) throws IOException {
        IMappingBuilder ret = IMappingBuilder.create("left", "right");
     ...
     *
     */
    private static @NotNull IMappingBuilder loadSlimSRG(@NotNull List<String> lines) throws IOException {
        IMappingBuilder ret = IMappingBuilder.create("left", "right");
        Map<String, IMappingBuilder.IClass> classes = new HashMap<>();
    ...
    private static @NotNull IMappingBuilder loadTSrg2(@NotNull List<String> lines) throws IOException {
        /*
    ...
    private static @NotNull IMappingBuilder loadTinyV1(@NotNull List<String> lines) throws IOException {
        /*
    ...
    private static @NotNull IMappingBuilder loadTinyV2(@NotNull List<String> lines) throws IOException {
        /*
    ...
    private static @NotNull IOException tiny2Exception(int line, String data) {
     ...
     *     "\0" to \0
     * */
    private static @NotNull String unescapeTinyString(@NotNull String value) {
    ...
    static @NotNull String escapeTinyString(@NotNull String value) {
        return value.replace("\\", "\\\\")
                .replace("\n", "\\n")
                .replace("\r", "\\r")
                .replace("\t", "\\t")
    ...
    static @NotNull String toDesc(@NotNull String type) {
    ...
    static @NotNull String toSource(@NotNull String desc) {
    ...
    static @NotNull String toSource(String name, @NotNull String desc) {
    ...
    private static String @NotNull [] rsplit(@NotNull String str, char chr, int count) {
    ...
    public static int compareLines(@NotNull String o1, @NotNull String o2) {
        String[] pt1 = o1.split(" ");
        String[] pt2 = o2.split(" ");
    ...
    public static int compareCls(@NotNull String cls1, @NotNull String cls2) {
    ...
    public static @NotNull String stripComment(@NotNull String str) {
        int idx = str.indexOf('#');
        if (idx == 0)
            return "";
        if (idx != -1)
    ...
    private static void swapFirst(String @NotNull [] values) {
        String tmp = values[0];
        values[0] = values[1];
        values[1] = tmp;
    }

    private static String @NotNull [] duplicate(String value, int count) {
    ...
    static void writeMeta(@NotNull Format format, @NotNull List<String> lines, @NotNull Element element, @NotNull Map<String, String> meta) {
        int indent = 0;
        switch (element) {
            case PACKAGE:
