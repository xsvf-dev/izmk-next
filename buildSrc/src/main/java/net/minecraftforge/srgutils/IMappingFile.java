...
public interface IMappingFile {
    public static IMappingFile load(@NotNull File path) throws IOException {
        try (InputStream in = new FileInputStream(path)) {
            return load(in);
        }
    }

    public static IMappingFile load(@NotNull InputStream in) throws IOException {
    ...
    public enum Format {
        ...
        public static @Nullable Format get(String name) {
