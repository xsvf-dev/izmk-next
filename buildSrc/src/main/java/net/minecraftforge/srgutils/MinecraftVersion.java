...
public class MinecraftVersion implements Comparable<MinecraftVersion> {
    public static @NotNull MinecraftVersion NEGATIVE = from("-1");

    public static @NotNull MinecraftVersion from(@NotNull String version) {
        try {
    ...
    private static @NotNull String fromSnapshot(int year, int week) {
    ...
    private static int[] splitDots(@NotNull String version) {
    ...
    private static @NotNull MinecraftVersion get(@NotNull String version) {
    ...
    @Override
    public int compareTo(@Nullable MinecraftVersion o) {
        if (o == null)
            return 1;
    ...
    private int compareFull(@NotNull MinecraftVersion o) {
